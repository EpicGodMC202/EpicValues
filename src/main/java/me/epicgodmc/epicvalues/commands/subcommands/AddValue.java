...
public class AddValue extends SubCommand
{
    ...
    public void onCommand(CommandSender sender, String[] args, Player playerSpecified) {
        ...
        if (sender.hasPermission("values.command.add.*") || sender.hasPermission("values.command.add."+identifier)) {
            ...
            if (playerSpecified != null) {
                ...
                if (value != -1) {
                    ...
                    valPlayer.incrementValue(identifier, value);
                    sender.sendMessage(mm.getMessage("valueIncrement")
                ...
                GlobalValues.getInstance().incrementValue(identifier, value);
                sender.sendMessage(mm.getMessage("valueIncrement")
                        .replace("%identifier%", identifier)
